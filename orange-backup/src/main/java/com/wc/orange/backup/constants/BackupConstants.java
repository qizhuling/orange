package com.wc.orange.backup.constants;
...
public interface BackupConstants {
	...
	/** 备份目录名称 */
	public static final String BACKUP_FOLDER_NAME = "_orange_backup";
	/** 备份目录 */
	...
	/** 默认备份文件名 */
	public static final String BACKUP_FILE_NAME = "orange" + SQL_EXT;
	/** 默认备份还原目录名称 */
