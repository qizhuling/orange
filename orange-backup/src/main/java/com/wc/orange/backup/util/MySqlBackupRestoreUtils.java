package com.wc.orange.backup.util;
...
public class MySqlBackupRestoreUtils {
	...
	public static boolean backup(String host,String port, String userName, String password, String backupFolderPath, String fileName,
		...
		stringBuilder.append("cmd /c mysqldump --opt ").append(" --add-drop-database ").append(" --add-drop-table ");
		stringBuilder.append(" -h").append(host).append(" -P").append(port).append(" -u").append(userName).append(" -p").append(password).append(" --default-character-set=utf8 ").append("--databases ").append(database);
		stringBuilder.append(" --result-file=").append(backupFilePath).append(" --ssl-mode=DISABLED ");
